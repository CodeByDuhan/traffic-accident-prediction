...
# klasör
os.makedirs(BASE_DIR / "models" / "op", exist_ok=True)
os.makedirs(BASE_DIR / "reports" / "results_op", exist_ok=True)
...
joblib.dump(xgb, BASE_DIR / "models" / "op" / "xgboost_op.pkl")
results.append({
    "model": "XGBoost",
...
joblib.dump(rf, BASE_DIR / "models" / "op" / "random_forest_op.pkl")
results.append({
    "model": "Random Forest",
...
nn.save(BASE_DIR / "models" / "op" / "neural_network_op.keras")
...
results_df.to_csv(BASE_DIR / "reports" / "results_op" / "op_model_results.csv", index=False)

# encoder, scaler ve feature sıralamasını dashboardta kullanmak üzere kayıt ediyorum
joblib.dump(encoder, BASE_DIR / "models" / "op" / "encoder_op.pkl")
joblib.dump(scaler, BASE_DIR / "models" / "op" / "scaler_op.pkl")
joblib.dump(X.columns.tolist(), BASE_DIR / "models" / "op" / "feature_order_op.pkl")
